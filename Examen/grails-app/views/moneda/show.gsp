...
<html>
    ...
    <body>
        ...
        <div id="show-moneda" class="content scaffold-show" role="main">
            ...
            <f:display bean="moneda" />
            <g:form resource="${this.moneda}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.moneda}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
